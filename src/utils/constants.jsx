...
export const MenuItemsForCharts = [
	...
	{ name: 'Annual Returns', icon: <FaRegChartBar style={{color: 'pink', width: '50px', height: '30px'}}/>, type: 'bar' },
	{ name: 'Drawdown', icon: <FaRegChartBar style={{color: 'red', width: '50px', height: '30px'}}/>, type: 'bar' },
